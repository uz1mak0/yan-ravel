...
export default function Home() {
  ...
  const handleProfileSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: replace with your real profile update request
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden font-sans bg-zinc-900">
      ...
      {/* Right-side sidebar */}
      <aside
        className={`fixed top-0 right-0 z-50 h-full w-72 bg-white/95 backdrop-blur-xl shadow-2xl transform transition-transform duration-300 ease-in-out ${
            ...
            <div className="flex mb-8 bg-gray-100 rounded-full p-1">
              <button
                ...
                className={`flex-1 py-2.5 rounded-full text-sm font-semibold transition-all ${
                  authMode === "signin" ? "bg-white text-gray-900 shadow" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Sign In
              </button>
              <button
                ...
                className={`flex-1 py-2.5 rounded-full text-sm font-semibold transition-all ${
                  authMode === "signup" ? "bg-white text-gray-900 shadow" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Sign Up
              </button>
            ...
            <form onSubmit={handleAuthSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input type="password" name="password" value={authData.password} onChange={handleAuthChange} required
                  className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-800" placeholder="••••••••" />
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity">
          <main className="relative w-full max-w-2xl p-8 md:p-12 bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-2xl max-h-[95vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex flex-col items-center text-center mb-10">
              <div className="h-24 w-24 rounded-full bg-gray-900 text-white flex items-center justify-center text-3xl font-bold mb-4">
                {profileData.fullName.trim() ? profileData.fullName.trim().charAt(0).toUpperCase() : "?"}
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" name="fullName" value={profileData.fullName} onChange={handleProfileChange}
                      ...
                      className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-800 disabled:bg-gray-50 disabled:text-gray-500"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea name="bio" value={profileData.bio} onChange={handleProfileChange}
                    disabled={!isProfileEditing}
                    rows={3}
                    className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-800 disabled:bg-gray-50 disabled:text-gray-500 resize-none"
